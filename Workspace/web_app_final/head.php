...
<head>
	...
	<script src="css/bootstrap-3.3.7/dist/js/jquery-3.1.0.min.js"></script>
	<script>window.jQuery || document.write('<script src="bootstrap-3.3.7/assets/js/vendor/jquery.min.js"><\/script>')</script>
	<script src="css/bootstrap-3.3.7/dist/js/bootstrap.min.js"></script>

	<script src="css/bootstrap-3.3.7/dist/js/bootstrap-slider.min.js"></script>

	<script src="css/bootstrap-3.3.7/dist/js/jquery.tablesorter.min.js"></script>
	<script src="css/bootstrap-3.3.7/dist/js/jquery.tablesorter.widgets.min.js"></script>
	...
	<script type="text/javascript" src="js/used_function.js"></script>
