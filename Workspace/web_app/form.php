<form method="post" action="">
	<p>Mode : <br>
		<input type="radio" name="mode" value="0" id="auto" onclick="hide()" <?php echo $auto_checked; ?> ><label for="auto"> Automatique</label><br>
		<input type="radio" name="mode" value="1" id="manual" onclick="show()" <?php echo $manual_checked; ?> ><label for="manual"> Manuel</label>
	</p>
